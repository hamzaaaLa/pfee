                ...
                <table class="table table-hover table-bordered">
                    ...
                    <tr>
                        <td class="actions">
                            ...
                            <a type="button" data-bs-toggle="modal" data-bs-target="#exampleModal{{$module->id_module}}">
                                <i class="fa-solid fa-trash"></i>
                            </a>
                            <!-- Modal Supprimer -->
                            <div class="modal fade" id="exampleModal{{$module->id_module}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            Voulez-vous vraiment supprimer cet module?
                                        </div>
